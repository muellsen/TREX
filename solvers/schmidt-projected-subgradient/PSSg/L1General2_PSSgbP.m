function [w,f,funEvals] = L1General2_PSSgbP(funObj,w,lambda,fopts,c_val,options)

% Assign c value to normalizing constant in TREX
fopts.normConst = c_val;
...
p = length(w);
[f,g] = pseudoGrad(funObj,w,lambda,fopts);
funEvals = 1;
...
for i = 1:maxIter
    ...
    [f_new,g_new] = pseudoGrad(funObj,w_new,lambda,fopts);
    funEvals = funEvals+1;
...
function [f,pGrad,H] = pseudoGrad(funObj,w,lambda,fopts)
