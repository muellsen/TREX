    ...
    for k = 1:numKappa
        ...
        for s = 1:numSig
            ...
            for r = 1:numRep
                ...
                %%%%%%%%%%%%%%%%%%%
                % Lasso solutions for initializing q-TREX, optional
                nl=20; % number of lasso restarts for trex, 1st one is always zero
                opts_lasso=[];
...
save(['LargeNExample_',date,'_p',num2str(pVec),'_n',num2str(n),'_nRep',num2str(numRep)])
