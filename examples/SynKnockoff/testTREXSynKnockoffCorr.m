...
for p=pVec
    ...
    for n=nVec
        ...
        for rhoValEps = [0.3,0.7]
            ...
            covMatEps = rhoValEps*ones(n,n);
            covMatEps(1:n+1:n^2) = 1;
            cholMatEps = chol(covMatEps);
                        
            sampleY = @() X*beta + sigma * cholMatEps*randn(n,1);
            ...
            for j = 1:ntrials
                ...
                save(['workspace_FDP_TPP_p',num2str(p),'_n',num2str(n),'_amp',num2str(10*amplitude),'_sigma',num2str(10*sigma1),'_corrNoise',num2str(rhoValEps*10)]);
